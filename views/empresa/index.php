                      ...
                      <div class="col">
                        <div class="row mb-3">
                          <div class="col-lg-4 col-md-12 col-sm-12">
                            <label for="ruc" class="form-label"><strong>R.U.C.</strong></label>
                            <input type="text" id="ruc" name="ruc" class="form-control" onkeypress="HideMessages(this);" value="<?php echo $this->empresa->rucempresa;?>" autofocus>
