...
<body>
        ...
        <div class="container" style="height: 100%;">
          <div class="card mt-3 mx-auto mb-4 border-0">
            <div class="card-header border-secondary">
              <h5 class="ml-2"><strong>Registro de Formas de Pago</strong></h5>
            </div>
            <div class="card-body">
              <div class="card col-md-10 mx-auto border-primary">
                ...
                <div class="card-body">
                  <form class="frmAction" action="<?php echo constant('URL'); ?>formapago/register" method="POST" data-form="insert" enctype="multipart/form-data" autocomplete="off">
                    <div class="row">
                      <div class="col">
                        <div class="row mb-3">
                          <div class="col">
                            <label for="formapago" class="form-label"><strong>Forma de Pago</strong></label>
                            <input type="text" id="formapago" name="formapago" class="form-control" onkeypress="HideMessages(this);">
  ...
  <script src="<?php echo URL . RESOURCE; ?>js/FormasPago.js"></script>
</body>
